...
-- 1. Who are the top performing employees by sales?
...
SELECT b.branch_name, SUM(w.total_sales) AS revenue
FROM branch b
...
-- 3. Which clients spend the most money?
SELECT c.client_name, SUM(w.total_sales) AS total_spent
FROM client c
